...
$conn = new PDO("mysql:host=$hostname;dbname=$db", $username, $password); // Creating a New PDO connection with the corresponding host,database name,user and password.  
